...
(function () {
  ...
  function fillMarquee() {
    var m = q('#marquee');
    if (!m) return;
    var words = '<span>Stronger every day —</span><span>No shortcuts —</span><span>Train loud —</span><span>FORGE —</span>';
  ...
  function wireForms() {
    document.querySelectorAll('form[data-fake]').forEach(function (f) {
      f.addEventListener('submit', function (e) {
        ...
        if (b) { b.textContent = 'Sent ✓ — see you at the gym'; b.disabled = true; }
      });
    });
  }
